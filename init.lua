...
require('lazy').setup({
  ...
  -- "gc" to comment visual regions/lines
  {
    ...
    config = function(_, opts)
      ...
      -- Allow using 'gcu' to uncomment multiple lines without needing to select them first
      ---Textobject for adjacent commented lines - from https://github.com/numToStr/Comment.nvim/issues/22#issuecomment-1272569139
